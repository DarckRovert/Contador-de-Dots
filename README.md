...
## Descripcion
DoTimer es un addon para rastrear la duracion de tus DoTs (Damage over Time), maldiciones, CC y otros efectos de duracion en World of Warcraft (TurtleWoW - Vanilla 1.12).

## Version
- **Version:** 1.2.0 - El Sequito del Terror Edition
...
- Alertas de sonido diferentes segun el tipo de hechizo
- Sonido de expiracion cuando quedan 5 segundos

### Traduccion al Espanol
- Menu completamente traducido
- Mensajes y tooltips en espanol
- Comandos de ayuda en espanol
...
## Comandos
- `/dotimer` o `/dot` - Abre el menu de configuracion
